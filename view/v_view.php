...
<div class="row">
    <div class="col-sm-12">
        <div class="card">
            <div class="card-body">
                <h4 class="card-title"><a class='statia' href="index.php?c=page&act=read&id=<?=$value['id']?>"><?=$value['name_article']?></a></h4>
                <p class="card-text"><?=$value['text_article']?></p>
                <a  class="btn btn-primary" href="index.php?c=page&act=read&id=<?=$value['id']?>">Читать полностью</a>
            </div>
        </div>
    </div>
</div>
